...
if (whitening)
  testXC = extract_features_kmeans(testX, centroids, rfSize, patchStride, IMG_DIM, M,P);
else
  testXC = extract_features_kmeans(testX, centroids, rfSize, patchStride, IMG_DIM);
end
